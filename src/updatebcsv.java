...
public class updatebcsv extends bmain {

    public updatebcsv(String data,int rown ) throws IOException {
    	String csvFilePath=document;
        
        // Assuming the new data you want to update
        String newData = data; // Replace with your new data
        try {
        	System.out.println(newData);
            updateCSV(csvFilePath, rown, newData);
        	JFrame fz=null;
			JOptionPane.showMessageDialog(fz,"Bill Updated.","Bill calculator",JOptionPane.INFORMATION_MESSAGE);
    ...
    private static void updateCSV(String csvFilePath, int rowToUpdate, String newData) throws IOException {
